      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden bg-background">
        ...
        <div className="relative z-10 max-w-md px-12 space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Join thousands of engineers practicing real-world scenarios — code review, system design, debugging, and more.
          </p>
          ...
          <div className="w-full max-w-sm space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Start practicing real-world professional judgment
              </p>
            </div>
